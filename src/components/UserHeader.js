...
const UserHeader = ({ children }) => {
  const [{ isCreatingPost, postContent }, dispatch] = useReducer(reducer, initialState);
      ...
      <div className="flex flex-col items-center space-y-6">
        <div className="relative w-full max-w-md">
          <div className="flex justify-between items-center">
            <div className="text-3xl text-white font-bold">{username}'s Posts</div>
            <button
              onClick={logout}
          ...
          <div className="flex flex-col items-center mt-6">
            <input
              ...
              placeholder={isCreatingPost ? "Share your thoughts..." : "Search by username..."}
            />
